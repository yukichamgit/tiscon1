...
ImageManager.loadAnimation = function(filename, hue) {
    return this.loadBitmap('http://unit8.net/tiscon1/img/animations/', filename, hue, true);
};

ImageManager.loadBattleback1 = function(filename, hue) {
    return this.loadBitmap('http://unit8.net/tiscon1/img/battlebacks1/', filename, hue, true);
};

ImageManager.loadBattleback2 = function(filename, hue) {
    return this.loadBitmap('http://unit8.net/tiscon1/img/battlebacks2/', filename, hue, true);
};

ImageManager.loadEnemy = function(filename, hue) {
    return this.loadBitmap('http://unit8.net/tiscon1/img/enemies/', filename, hue, true);
};

ImageManager.loadCharacter = function(filename, hue) {
    return this.loadBitmap('http://unit8.net/tiscon1/img/characters/', filename, hue, false);
};

ImageManager.loadFace = function(filename, hue) {
    return this.loadBitmap('http://unit8.net/tiscon1/img/faces/', filename, hue, true);
};

ImageManager.loadParallax = function(filename, hue) {
    return this.loadBitmap('http://unit8.net/tiscon1/img/parallaxes/', filename, hue, true);
};

ImageManager.loadPicture = function(filename, hue) {
    return this.loadBitmap('http://unit8.net/tiscon1/img/pictures/', filename, hue, true);
};

ImageManager.loadSvActor = function(filename, hue) {
    return this.loadBitmap('http://unit8.net/tiscon1/img/sv_actors/', filename, hue, false);
};

ImageManager.loadSvEnemy = function(filename, hue) {
    return this.loadBitmap('http://unit8.net/tiscon1/img/sv_enemies/', filename, hue, true);
};

ImageManager.loadSystem = function(filename, hue) {
    return this.loadBitmap('http://unit8.net/tiscon1/img/system/', filename, hue, false);
};

ImageManager.loadTileset = function(filename, hue) {
    return this.loadBitmap('http://unit8.net/tiscon1/img/tilesets/', filename, hue, false);
};

ImageManager.loadTitle1 = function(filename, hue) {
    return this.loadBitmap('http://unit8.net/tiscon1/img/titles1/', filename, hue, true);
};

ImageManager.loadTitle2 = function(filename, hue) {
    return this.loadBitmap('http://unit8.net/tiscon1/img/titles2/', filename, hue, true);
};
...
AudioManager._path           = 'http://unit8.net/tiscon1/audio/';
...
SceneManager.initGraphics = function() {
    ...
    Graphics.setLoadingImage('http://unit8.net/tiscon1/img/system/Loading.png');
